    ...
    <div class="card">
        <form method="post" action="" name="frmpatient" onSubmit="return validateform()" style="padding: 10px">
            <div class="form-group">
                ...
                <div class="form-line">
                    <input class="form-control" type="text" name="patientname" id="patientname" value="<?php echo isset($rsedit['patientname']) ? htmlspecialchars($rsedit['patientname']) : ''; ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Address</label>
                <div class="form-line">
                    <input class="form-control" name="address" id="tinymce" value="<?php echo isset($rsedit['address']) ? htmlspecialchars($rsedit['address']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                <label>City</label>
                <div class="form-line">
                    <input class="form-control" type="text" name="city" id="city" value="<?php echo isset($rsedit['city']) ? htmlspecialchars($rsedit['city']) : ''; ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input class="form-control" type="text" name="pincode" id="pincode" value="<?php echo isset($rsedit['pincode']) ? htmlspecialchars($rsedit['pincode']) : ''; ?>" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input class="form-control" type="password" name="confirmpassword" id="confirmpassword" value="<?php echo isset($rsedit['confirmpassword']) ? htmlspecialchars($rsedit['confirmpassword']) : ''; ?>" />
                </div>
            </div>
                ...
                <div class="form-line">
                    <select class="form-control show-tick" name="select2" id="select2">
                        ...
                        foreach ($blood_groups as $bg) {
                            $selected = isset($rsedit['bloodgroup']) && $rsedit['bloodgroup'] === $bg ? 'selected' : '';
            ...
            <div class="form-group">
                <label>Gender</label>
                <div class="form-line">
                    <select class="form-control show-tick" name="select3" id="select3">
                        <option value="">Select</option>
                        <?php
                        $genders = array("MALE", "FEMALE");
                        foreach ($genders as $gender) {
                            $selected = isset($rsedit['gender']) && $rsedit['gender'] === $gender ? 'selected' : '';
            ...
            <div class="form-group">
                ...
                <div class="form-line">
                    <input class="form-control" type="date" name="dateofbirth" max="<?php echo date("Y-m-d"); ?>" id="dateofbirth" value="<?php echo isset($rsedit['dob']) ? $rsedit['dob'] : ''; ?>" />
                </div>
            </div>
