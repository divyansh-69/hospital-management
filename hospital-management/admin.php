...
if(isset($_POST['submit']))
{
    if(isset($_GET['editid']))
    {
        ...
        $sql ="UPDATE admin SET adminname='$adminname', loginid='$loginid', password='$password', status='$status' WHERE adminid='$_GET[editid]'";
    ...
    else
    {
        ...
        $sql ="INSERT INTO admin(adminname,loginid,password,status) values('$adminname','$loginid','$password','$status')";
        if($qsql = mysqli_query($con,$sql))
        {
            echo "<div class='alert alert-success'>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">   
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control"  name="adminname" id="adminname" value="<?php echo isset($rsedit['adminname']) ? $rsedit['adminname'] : ''; ?>"/>
                                    </div>
                                </div>
                            </div>   
                        </div>
                        <div class="row clearfix"> 
                            <div class="col-sm-12">                           
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="loginid" id="loginid" value="<?php echo isset($rsedit['loginid']) ? $rsedit['loginid'] : ''; ?>" />
                                    </div>
                                </div>    
                            </div>                      
                        </div>  
                        <div class="row clearfix"> 
                            <div class="col-sm-12">                              
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="password" class="form-control"  name="password" id="password" value="<?php echo isset($rsedit['password']) ? $rsedit['password'] : ''; ?>"/>
                                    </div>
                                </div>
                            </div>                          
                        </div> 
                        <div class="row clearfix"> 
                            <div class="col-sm-12">                              
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <input type="password" class="form-control"  name="cnfirmpassword" id="cnfirmpassword" value="<?php echo isset($rsedit['confirmpassword']) ? $rsedit['confirmpassword'] : ''; ?>"/>
                                    </div>
                                </div>
                            </div>                          
                        </div> 
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group drop-custum">
                                    ...
                                    <select class="form-control show-tick" name="select">
                                        ...
                                        foreach($arr as $val)
                                        {
                                            if(isset($rsedit['status']) && $val == $rsedit['status'])
                                            {
