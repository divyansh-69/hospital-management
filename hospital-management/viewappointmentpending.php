...
if(isset($_GET['approveid']) && isset($_GET['patientid'])) {
    $approveid = $_GET['approveid'];
    $patientid = $_GET['patientid'];

    $sql_patient = "UPDATE patient SET status='Active' WHERE patientid='$patientid'";
    $qsql_patient = mysqli_query($con, $sql_patient);

    $sql_appointment = "UPDATE appointment SET status='Approved' WHERE appointmentid='$approveid'";
    $qsql_appointment = mysqli_query($con, $sql_appointment);
