...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">Add New Order</li>
    </ul>
  </div>
</div>
      ...
      <table width="490" border="3">
        <tbody>
          ...
          <tr>
            ...
            <td width="66%">
              <textarea name="address" id="address" cols="45" rows="5"><?php echo $rsedit['address']; ?></textarea>
            </td>
          </tr>
          <tr>
            <td>Mobile Number</td>
          ...
          <tr>
            <td>Any note</td>
            <td>
              <textarea name="note" id="note" cols="45" rows="5"><?php echo $rsedit['note']; ?></textarea>
            </td>
          </tr>
          <tr>
