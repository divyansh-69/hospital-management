...
<table class="table table-bordered table-striped">
    ...
    <?php
    $sql = "SELECT * FROM treatment_records LEFT JOIN treatment ON treatment_records.treatmentid=treatment.treatmentid WHERE treatment_records.patientid='$_GET[patientid]'";
    ...
    while($rs = mysqli_fetch_array($qsql)) {
        ...
        if(file_exists("treatmentfiles/$rs[uploads]") && $rs['uploads'] != "") {
