...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i' rel='stylesheet' type='text/css'>
    <style>
        body {
                        ...
                        <form action="" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-input"><?=$pdtl['user_name']?></div>
                                </div>
                                <br/>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-input"><?=$pdtl['email']?></div>
                                </div>
                                <br/>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-input"><?=$pdtl['dob']?></div>
                                </div>
                                <br/>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-input"><?=$pdtl['street_address']?></div>
                                </div>
                                <br/>
                            </div>
                        </form>	
