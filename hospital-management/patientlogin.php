...
{
    $loginid = mysqli_real_escape_string($con, $_POST['loginid']); // Prevent SQL injection
    $password = mysqli_real_escape_string($con, $_POST['password']); // Prevent SQL injection
    $sql = "SELECT * FROM patient WHERE loginid='$loginid' AND password='$password' AND status='Active'";
