...
if(isset($_GET['delid'])) {
    $delid = $_GET['delid'];
    $sql = "DELETE FROM billing_records WHERE billingid='$delid'";
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            while($rs = mysqli_fetch_array($qsql)) {
                ...
                elseif($rs['bill_type'] == "Consultancy Charge") {
                    // Consultancy Charge
                ...
                elseif($rs['bill_type'] == "Treatment Cost") {
                    // Treatment Cost
                ...
                elseif($rs['bill_type'] == "Prescription charge") {
    ...
    <table class="table table-bordered table-striped">
        <tbody>
            ...
            <tr>
                ...
                <td width="95">&nbsp;$ <?php echo $taxamt = 5 * ($billamt / 100); ?></td>
            </tr>
            <tr>
