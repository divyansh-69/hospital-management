...
if(isset($_POST['submit']))
{
    ...
    $admissiontme = mysqli_real_escape_string($con, $_POST['admissiontme']);
    ...
    $bloodgroup = mysqli_real_escape_string($con, $_POST['select2']);
    $gender = mysqli_real_escape_string($con, $_POST['select3']);
    $dob = mysqli_real_escape_string($con, $_POST['dateofbirth']);

    $sql ="UPDATE patient SET patientname='$patientname',admissiondate='$admissiondate',admissiontime='$admissiontme',address='$address',mobileno='$mobilenumber',city='$city',pincode='$pincode',loginid='$loginid',bloodgroup='$bloodgroup',gender='$gender',dob='$dob' WHERE patientid='$_SESSION[patientid]'";
