                ...
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="admit.php" class=" waves-effect waves-block">Admit Patient</a></li>
                            <li><a href="discharge.php" class=" waves-effect waves-block">Discharge Patient</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle toggled waves-effect waves-block"><i
                        ...
                        <ul class="ml-menu" style="display: block;">
                            ...
                            <li><a href="viewroom.php" class=" waves-effect waves-block">View Room</a></li>
                ...
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="patadmitdisc.php">Admit & Discharge</a></li>
