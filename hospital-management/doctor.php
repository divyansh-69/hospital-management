...
if(isset($_POST['submit'])) {
    if(isset($_GET['editid'])) {
        ...
        if($stmt = mysqli_prepare($con, $sql)) {
            mysqli_stmt_bind_param($stmt, "ssissssssi", $doctorname, $mobileno, $departmentid, $loginid, $password, $status, $education, $experience, $consultancy_charge, $editid);
        ...
        if($stmt = mysqli_prepare($con, $sql)) {
            mysqli_stmt_bind_param($stmt, "ssisssssi", $doctorname, $mobileno, $departmentid, $loginid, $password, $status, $education, $experience, $consultancy_charge);
            if(mysqli_stmt_execute($stmt)) {
			...
			<div class="card">
				<form method="post" action="" name="frmdoct" onSubmit="return validateform()" style="padding: 10px">
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="doctorname" id="doctorname" value="<?php echo isset($rsedit['doctorname']) ? htmlspecialchars($rsedit['doctorname']) : ''; ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="mobilenumber" id="mobilenumber" value="<?php echo isset($rsedit['mobileno']) ? htmlspecialchars($rsedit['mobileno']) : ''; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="loginid" id="loginid" value="<?php echo isset($rsedit['loginid']) ? htmlspecialchars($rsedit['loginid']) : ''; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="password" name="password" id="password" value="<?php echo isset($rsedit['password']) ? htmlspecialchars($rsedit['password']) : ''; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="password" name="cnfirmpassword" id="cnfirmpassword" value="<?php echo isset($rsedit['password']) ? htmlspecialchars($rsedit['password']) : ''; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="education" id="education" value="<?php echo isset($rsedit['education']) ? htmlspecialchars($rsedit['education']) : ''; ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="experience" id="experience" value="<?php echo isset($rsedit['experience']) ? htmlspecialchars($rsedit['experience']) : ''; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-line">
							<input class="form-control" type="text" name="consultancy_charge" id="consultancy_charge" value="<?php echo isset($rsedit['consultancy_charge']) ? htmlspecialchars($rsedit['consultancy_charge']) : ''; ?>"/>
						</div>
					</div>
